 ...
 */
public class PriorityAsyncTask extends AsyncTask<String, Void, String> {


     ArrayList<ModelClass> priorityalllist = new ArrayList<>();

    ArrayList<String> emptNameArray = new ArrayList<>();
    ArrayList<String> emptid = new ArrayList<>();
    String empName, emp_response_code,response;


    PriorityAdapter  assignToAdapter;
    Spinner assingToSpin;
    Activity activity;
    String url ;
    ProgressDialog pDialog;

    public PriorityAsyncTask(Activity activity,ArrayList assignToArray,PriorityAdapter assignToAdapter,Spinner assingToSpin,String url){
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            for (int j = 0; j < jsonArray.length(); j++) {
                ...
                empName = jObj.getString("Priority");
                Log.v("EmpName",empName);
               String id= jObj.getString("PK_PriorityID");
            ...
            for(int i= 0;i< emptNameArray.size();i++){
                ...
                modelClass.setContactID(emptid.get(i));

                priorityalllist.add(modelClass);
            }
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            if (emp_response_code.equals("1")) {
                ...
                assignToAdapter = new PriorityAdapter(activity, android.R.layout.simple_list_item_1, priorityalllist);
    ...
    public class PriorityAdapter extends BaseAdapter {
        ...
        public PriorityAdapter(Activity context, int textViewResourceId,
