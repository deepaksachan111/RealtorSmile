...
public class Inspection extends Activity implements View.OnClickListener {


    private ArrayList<String> addcontacttypelist2 = new ArrayList<>();

    ArrayList<ModelClass> modelclasscontacttype2list = new ArrayList<>();
    ...
    ArrayList<String> browseinglist = new ArrayList<>();
    private ArrayAdapter<String> contacttype2Adapter2;

    ArrayList<ModelClass> modelClassRelatedto2ArrayList = new ArrayList<>();

    private ArrayList<String> startTimelist = new ArrayList<>();

    private String aciviityuserId;

    private int noofobjects;

    private Spinner inspection_assignedTo, inspection_contact_type1, inspection_contact_type2,
            spinner_enspection_starttime, spinner_inspection_endtime, spinner_inspection_relatedto, spinner_inspection_relatedto2, spinner_browselisting,
            spinner_inspection_priorty1, spinner_inspection_priorty2, spinner_inspection_reminderbefore;
    private EditText edt_popup_inspection_subject, edtinspection_selectdate, edt_inspection_remark;
    private CheckBox check_inspection_emailnotification, check_inspection_smsnotification;
    private Button inspection_saveBtn, inspection_save_n_NewBtn, inspection_cancelBtn;
    private SimpleDateFormat dateFormatter;
    private Calendar cal;
    private int day;
    private int month;
    private int year;
    private String contacttpe1reponse_code, response_code;
    private ImageView back ;
    private LinearLayout spinneractivity_inspection_relatedto2_linear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_popup_inspection_subject.setOnClickListener(this);
        edtinspection_selectdate.setOnClickListener(this);
        edt_inspection_remark.setOnClickListener(this);
        inspection_saveBtn.setOnClickListener(this);
        inspection_save_n_NewBtn.setOnClickListener(this);
        inspection_cancelBtn.setOnClickListener(this);
        ...
        edtinspection_selectdate.setText(dateFormatter.format(cal.getTime()));
        //start time
        startTime();
        //assignTo
        assigntodata();
    ...
    private void startTime() {
        ...
        ArrayAdapter<String> starttimeadapter = new ArrayAdapter<String>(Inspection.this, android.R.layout.simple_spinner_dropdown_item, startTimelist);
        spinner_enspection_starttime.setAdapter(starttimeadapter);
        spinner_enspection_starttime.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void assigntodata() {
        ...
        AssignToAsyncTask assignToAsyncTask = new AssignToAsyncTask(this, assignToArray, assignToAdapter, inspection_assignedTo, stringassginto_url);
        assignToAsyncTask.execute(stringassginto_url);


        inspection_assignedTo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void contacttypeasynktask() {
        ...
        ContactTypeAsyncTask contactTypeAsyncTask = new ContactTypeAsyncTask(this, contacttypenamelist1, contacttypeidlist1, customListArray, contactTypeAdapter1, inspection_contact_type1, addcontacttype1url);
        contactTypeAsyncTask.execute();

        inspection_contact_type1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                String get_spinneritemcontacttype1 = selectedItem.getContactID();
        ...
        inspection_contact_type2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {

                ModelClass selectedItem = (ModelClass) modelclasscontacttype2list.get(position);
    ...
    private void relatedtodata() {
        ...
        spinner_inspection_relatedto.setAdapter(relatedtoarrayAdapter1);
        spinner_inspection_relatedto.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                spinneractivity_inspection_relatedto2_linear.setVisibility(View.VISIBLE);
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                spinneractivity_inspection_relatedto2_linear.setVisibility(View.GONE);
            }
        });

        spinner_inspection_relatedto2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void browselisting() {
        String url = "http://rsmile.quaeretech.com/RealtorSmile.svc/GetListingExtendedTitle/" + aciviityuserId;
        new BrowseListingAsynktask().execute(url);
    }
    ...
    private void priorityasynctask() {
        ...
        PriorityAsyncTask priorityAsyncTask = new PriorityAsyncTask(this, priorityarrayList, priorityadapter, spinner_inspection_priorty1, url);
        priorityAsyncTask.execute(url);

        spinner_inspection_priorty1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void statusasynctask() {
        ...
        StatusAsyncTask statusAsyncTask = new StatusAsyncTask(this, statusarrayList, statusadapter, spinner_inspection_priorty2, url);
        statusAsyncTask.execute(url);

        spinner_inspection_priorty2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void reminderasynctask() {
        ...
        ReminderBeforeAsyncTask reminderAsyncTask = new ReminderBeforeAsyncTask(this, reminderarrayList, reminderadapter, spinner_inspection_reminderbefore, url);
        reminderAsyncTask.execute(url);
        spinner_inspection_reminderbefore.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void findID() {
        ...
        inspection_assignedTo = (Spinner) findViewById(R.id.inspection_assignedTo);
        edt_popup_inspection_subject = (EditText) findViewById(R.id.edt_popup_inspection_subject);
        inspection_contact_type1 = (Spinner) findViewById(R.id.inspection_contact_type1);
        inspection_contact_type2 = (Spinner) findViewById(R.id.inspection_contact_type2);
        edtinspection_selectdate = (EditText) findViewById(R.id.edtinspection_selectdate);
        spinner_enspection_starttime = (Spinner) findViewById(R.id.spinner_enspection_starttime);
        //  spinner_inspection_endtime =(Spinner)findViewById(R.id.spinner_inspection_endtime);
        spinner_inspection_relatedto = (Spinner) findViewById(R.id.spinner_inspection_relatedto);
        spinneractivity_inspection_relatedto2_linear = (LinearLayout) findViewById(R.id.spinneractivity_inspection_relatedto2_linear);
        spinner_inspection_relatedto2 = (Spinner) findViewById(R.id.spinner_inspection_relatedto2);
        spinner_browselisting = (Spinner) findViewById(R.id.spinner_inspection_browselisting);

        spinner_inspection_priorty1 = (Spinner) findViewById(R.id.spinner_inspection_priorty1);
        spinner_inspection_priorty2 = (Spinner) findViewById(R.id.spinner_inspection_priorty2);

        check_inspection_emailnotification = (CheckBox) findViewById(R.id.check_inspection_emailnotification);
        check_inspection_smsnotification = (CheckBox) findViewById(R.id.check_inspection_smsnotification);
        spinner_inspection_reminderbefore = (Spinner) findViewById(R.id.spinner_inspection_reminderbefore);
        edt_inspection_remark = (EditText) findViewById(R.id.edt_inspection_remark);


        inspection_saveBtn = (Button) findViewById(R.id.inspection_saveBtn);
        inspection_save_n_NewBtn = (Button) findViewById(R.id.inspection_save_n_NewBtn);
        inspection_cancelBtn = (Button) findViewById(R.id.inspection_cancelBtn);

    }

    @Override
    public void onClick(View v) {
        if (v == edtinspection_selectdate) {
            setdate();
        }else if(v == back){
            finish();
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int j = 0; j < jsonArray.length(); j++) {
                    ...
                    contactnamelist.add(contactType);
                ...
                for (int i = 0; i < contactnamelist.size(); i++) {
                    ...
                    data.setContactName(contactnamelist.get(i));
                    data.setContactID(contactidlist.get(i));
            ...
            try {
                if (contacttpe1reponse_code.equals("1")) {
                    ...
                    contacttype2Adapter2 = new ArrayAdapter<String>(Inspection.this, android.R.layout.simple_list_item_1, addcontacttypelist2);
                    inspection_contact_type2.setAdapter(contacttype2Adapter2);
                ...
                Toast.makeText(Inspection.this, "Connection  Failed ", Toast.LENGTH_LONG).show();
    ...
    private class RelatedtoAsyncTask2 extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Inspection.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (response_code.equals("1")) {
                ...
                ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<String>(Inspection.this, android.R.layout.simple_list_item_1, relatedtolist2);

                arrayAdapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
                spinner_inspection_relatedto2.setAdapter(arrayAdapter2);
            } else {
                spinneractivity_inspection_relatedto2_linear.setVisibility(View.GONE);
    ...
    private class BrowseListingAsynktask extends AsyncTask<String, Void, String> {
        ProgressDialog pDialog = new ProgressDialog(Inspection.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int j = 0; j < jsonArray.length(); j++) {
                    ...
                    JSONObject jObj = jsonArray.getJSONObject(j);
                    String title = jObj.getString("ExtendedTitle");
                    String id = jObj.getString("PK_ListingId");
                    response_code = jObj.getString("ResponseCode");

                    browseinglist.add(title);
            ...
            try {
                if (response_code.equals("1")) {
                    ...
                    ArrayAdapter<String> spinner_assignToAdapter = new ArrayAdapter<String>(Inspection.this, android.R.layout.simple_spinner_item, browseinglist);
                    spinner_assignToAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spinner_browselisting.setAdapter(spinner_assignToAdapter);
